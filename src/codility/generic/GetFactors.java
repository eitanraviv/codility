...
public class GetFactors
{
	...
	public void more() {
		...
		assertArrayEquals(new int[] {1,4,2}, gf.solution(4));
		assertArrayEquals(new int[] {1,5}, gf.solution(5));
		assertArrayEquals(new int[] {1,6,2,3}, gf.solution(6));
		assertArrayEquals(new int[] {1,9,3}, gf.solution(9));
		assertArrayEquals(new int[] {1,16,2,8,4}, gf.solution(16));
		assertArrayEquals(new int[] {1,17}, gf.solution(17));
		assertArrayEquals(new int[] {1,24,2,12,3,8,4,6}, gf.solution(1*2*3*4));
